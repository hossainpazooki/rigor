...
been seen red on a known-bad twin in `tests/` (**640** tests, `node --test`,
measured 2026-09-22 — 591 on 2026-09-01, to 626 on 2026-09-15 via the seven
...
`check-tier-placement` (6) and `check-harvest` (2) work, to 640 via the six
twins pinning the four gaps a cross-model review found on 2026-09-22).
